...
const PlayerInfoMobile = (): JSX.Element => {
  ...
  return (
    <div className="PlayerInfoMobile">
      ...
      <div
        className="PlayerInfoMobile__P1QuestionMark"
      ...
      {/* eslint-disable-next-line jsx-a11y/click-events-have-key-events */}
      <div
        className="PlayerInfoMobile__P1Name"
        onClick={toggleOverlay}
        role="button"
        tabIndex={0}
      >
      ...
      {/* eslint-disable-next-line jsx-a11y/click-events-have-key-events */}
      <div
        className="PlayerInfoMobile__P2QuestionMark"
        onClick={toggleOverlay}
        role="button"
        tabIndex={0}
      >
      ...
      {/* eslint-disable-next-line jsx-a11y/click-events-have-key-events */}
      <div
        className="PlayerInfoMobile__P2Name"
        onClick={toggleOverlay}
        role="button"
        tabIndex={0}
      >
